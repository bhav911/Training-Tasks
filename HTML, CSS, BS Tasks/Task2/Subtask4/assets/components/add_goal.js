          ...
          <form action="#" id="new-habit-form">
            <div class="row">
              ...
              <div class="col-12  px-4">
                <div class="row mb-3 border py-3 rounded-3 justify-content-between bg-white">
                  <div class="col-2">Repeat Every</div>
...
<table id="habit-table" class="w-100 table table-striped table-hover">
  <thead>
